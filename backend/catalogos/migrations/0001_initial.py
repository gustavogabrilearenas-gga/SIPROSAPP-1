    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('codigo', models.CharField(max_length=20, unique=True)),
                ('version', models.CharField(choices=[('1.0', '1.0'), ('1.1', '1.1'), ('2.0', '2.0')], max_length=10)),
                ('descripcion', models.TextField(blank=True)),
                ('tamaño_lote', models.IntegerField(help_text='Tamaño estándar del lote')),
                ('unidad', models.CharField(max_length=20)),
                ('tiempo_total', models.DecimalField(decimal_places=2, help_text='Tiempo total en horas', max_digits=5)),
                ('activa', models.BooleanField(default=True)),
