    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maquina', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='planes_mantenimiento', to='catalogos.maquina')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maquina', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='ordenes_trabajo', to='catalogos.maquina')),
                ('plan_mantenimiento', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ordenes_generadas', to='mantenimiento.planmantenimiento')),
                ('tipo', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='mantenimiento.tipomantenimiento')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maquina', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='historial_mantenimiento', to='catalogos.maquina')),
                ...
                ('orden_trabajo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='historial', to='mantenimiento.ordentrabajo')),
                ('tipo', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='mantenimiento.tipomantenimiento')),
            ],
            options={
