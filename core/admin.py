...
@admin.register(OrdenTrabajoRepuesto)
class OrdenTrabajoRepuestoAdmin(admin.ModelAdmin):
    list_display = ['orden_trabajo', 'repuesto', 'cantidad_planificada', 'cantidad_real']
    search_fields = ['orden_trabajo__codigo', 'repuesto__nombre']


@admin.register(HistorialMantenimiento)
class HistorialMantenimientoAdmin(admin.ModelAdmin):
    list_display = ['maquina', 'tipo', 'fecha', 'orden_trabajo']
    list_filter = ['tipo', 'maquina']
